            ...
            <div className="lg:flex my-10">
                ...
                <div className="w-full h-64 lg:w-1/2 lg:h-auto">
                    <div className="w-full h-full bg-black opacity-25">
                        <img src="https://images.unsplash.com/photo-1508394522741-82ac9c15ba69?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=748&q=80" alt="" className="w-full h-full bg-cover" />
                    </div>
                </div>
            </div>
            <Footer />
